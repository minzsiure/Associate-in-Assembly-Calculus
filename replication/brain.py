...
class Brain:
    ...
    def __init__(self, num_areas=2, n=1000, beta=0.1, p=None, k=None):
        ...
        self.areas = [Area(n=self.n, p=self.p, k=k)
    ...
    def wipe_all_activations(self):
        ...
        '''
        for i in range(self.num_areas):
            self.areas[i].activations = np.zeros(self.areas[i].n, dtype=float)
    ...
    def associate(self, input, area1_index, area2_index, area3_index):
        """
